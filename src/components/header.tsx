        ...
        <header className='w-full py-4 pt-6 px-2'>
            <div className="block sm:flex w-full align-middle tracking-widest">
                <div className='flex items-center justify-between sm:block w-full my-2 sm:my-0'>
                    ...
                    <div className='block sm:hidden' onClick={()=>setOpen(!open)}><BiMenu size="2em"/></div>
                </div>
                <nav className={`${open ? "block": "hidden"} transition ease-in-out delay-150 w-full uppercase flex items-center my-2 sm:my-0`}>
                    <ul className='block sm:flex w-full items-center justify-evenly text-slate-700'>
                ...
                <div className={`${open ? "block": "hidden"} w-full flex justify-start sm:justify-end`}>
